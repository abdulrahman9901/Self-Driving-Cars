...
WAYPOINTS_FILENAME = 'D:/Self driving car/CarlaSimulator/PythonClient/Course1FinalProject/racetrack_waypoints.txt'
...
def exec_waypoint_nav_demo(args):
    ...
    with make_carla_client(args.host, args.port) as client:
        ...
        waypoints_np   = None
        with open(waypoints_file,'r') as waypoints_file_handle:
